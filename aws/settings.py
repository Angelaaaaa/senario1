...
# he utility of this two lines is if a user want to access
...
SECRET_KEY = 'iv@g@wvt@v$mgke_l3%=w!_!*eronpn$htb2-w_l3t^gi(xg^7'
...
TEMPLATE_DIRS = (
    ...
    # Don't forget to use absolute paths, not relative paths.
      os.path.join(os.path.dirname(__file__),'/Users/yuan/Documents/aws/login/templates'),
)
